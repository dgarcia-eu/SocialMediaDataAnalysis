...
# Projects information for evaluation
...
- Based on replication/reproduction of a paper or an own research question
- Projects timeline:
  - Next week we will go more in detail into evaluation criteria, report parts, project examples, and have a Q&A during the lecture
  - Over the next days, I will populate a document with examples of papers you can replicate/reproduce
  - by 23.07 (**mandatory**): Writing a post on Ilias forum with the paper to replicate or research question and the plan to do so. 
  - I will provide feedback on Ilias until 28.07. Questions are also welcome before that date - **prepare your project by the end of July**
  - Tentative report submission deadline: 24.09
...
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 1)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 2)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 3)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 4)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 5)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 6)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 7)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 8)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 9)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 10)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 11)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 12)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 13)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 14)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 15)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 16)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 17)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 18)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 19)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 20)
```
---
```{r, echo=F}
magick::image_read_pdf("Session08-part2-LM-LEIA.pdf", pages = 21)
```
